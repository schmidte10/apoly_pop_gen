...
apoly_populations_pca <- pcadapt(input =apoly_pcadapt, K =2)
...
pdf("outputs/apoly_populations_pca.pdf")
plot(apoly_populations_pca, option = "scores", i=1, j=2, pop = poplist.names$V3)
dev.off()

pdf("outputs/pcadapt_apoly_manhattan.pdf")
plot(apoly_populations_pca, option= "manhattan") 
dev.off() 

pdf("outputs/pcadapt_apoly_qqplot.pdf") 
